...
var postManager = function () {
    ...
    var container = document.getElementById('content');
        ...
        postManager.prototype.posts.sort((a, b) => (a.userId > b.userId) ? 1 : -1);
        const data = postManager.prototype.posts;
        var ul = document.getElementById("post");

        data.forEach(element => {
            var li = document.createElement("li");
            li.appendChild(document.createTextNode(element.userId + " " + element.title));
